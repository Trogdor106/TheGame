...
MeshAndHitBox ObjLoader::LoadObj2(const char* filename, glm::vec4 baseColor)
{
	//Makes our maxmin so we can keep track during the loading rather then pass the data aferwards in another loop
	HitBox toReturn;
	...
	MeshAndHitBox box = { result, toReturn };
	return box;
}
