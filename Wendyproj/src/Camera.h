...
public:
	...
	inline const glm::vec3& GetForward() const { return glm::vec3(-BackX, -BackY, -BackZ); }
	// Gets the up vector of this camera
	inline const glm::vec3& GetUp() const { return glm::vec3(UpX, UpY, UpZ); }
	// Gets the right hand vector of this camera
	inline const glm::vec3& GetRight() const { return glm::vec3(-LeftX, -LeftY, -LeftZ); }
